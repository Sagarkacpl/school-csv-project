...
try {
    ...
    foreach ($ageGroups as $label => $condition) {
        $sql = "SELECT COUNT(*) as count FROM ap_ageing WHERE MONTH(month) = '$month' AND deleted_status = 0 AND $condition";
    ...
    foreach ($ageGroups as $label => $condition) {
        ...
        $balanceSQL = "SELECT SUM(balance_books) as total_balance FROM ap_ageing WHERE MONTH(month) = '$month' AND deleted_status = 0 AND $condition";
        ...
        $accountSQL = "SELECT DISTINCT creditor_name FROM ap_ageing WHERE MONTH(month) = '$month' AND deleted_status = 0 AND $condition LIMIT 3";
